...
<ul>
  ...
  <li>
    Request full account deletion via the
    <a href="/contact">contact form</a>. We will remove your account
    record, all your connections, all your OAuth records, and all
    Secret Manager entries tied to them.
  </li>
</ul>
